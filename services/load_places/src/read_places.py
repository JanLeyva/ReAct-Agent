        ...
        formatted_data = pl.DataFrame(
            {
                ...
                "international_phone_number": [
                    response_place.get("international_phone_number", None)
                ],
                "formatted_address": [response_place.get("formatted_address", None)],
                "formatted_phone_number": [
                    response_place.get("formatted_phone_number", None)
                ],
                ...
                "current_opening_hours": [
                    open_hours.get("open_now", None) if open_hours else None
                ],
                "weekday_text": [
                    open_hours.get("weekday_text", None) if open_hours else None
                ],
                ...
                "wheelchair_accessible_entrance": [
                    response_place.get("wheelchair_accessible_entrance", None)
                ],
                ...
                "serves_vegetarian_food": [
                    response_place.get("serves_vegetarian_food", None)
                ],
